...
//      showServiceOverlay();
  ...
  private void setDefaultValues() {
    ...
    int numberOfLines = prankSettings.getNumberOfLines() < prankSettings.NUMBER_OF_LINES_OPTIONS.length ? prankSettings.NUMBER_OF_LINES_OPTIONS[prankSettings.getNumberOfLines()] : prankSettings.NUMBER_OF_LINES_OPTIONS[0];
...
//    Toast.makeText(getApplicationContext(), "Starting service showServiceOverlay...", Toast.LENGTH_SHORT).show();
    ...
    int lineNumbers = prankSettings.getNumberOfLines() < prankSettings.NUMBER_OF_LINES_OPTIONS.length ? prankSettings.NUMBER_OF_LINES_OPTIONS[prankSettings.getNumberOfLines()] : prankSettings.NUMBER_OF_LINES_OPTIONS[0];
    float lineLocation = prankSettings.getLocationOfLines() < prankSettings.SETTING_LINE_LOCATION.length ? prankSettings.SETTING_LINE_LOCATION[prankSettings.getLocationOfLines()] : prankSettings.SETTING_LINE_LOCATION[0];
